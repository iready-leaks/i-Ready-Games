function createUnityInstance(t, n, d) {
    ...
    function r(e) {
        ...
        (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && m.stackTraceRegExp && m.stackTraceRegExp.test(n) && E(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
    }
    function e(e, t, n) {
        var r = e[t];
    ...
    function E(r, o, a) {
        m.symbols ? P(T(r, m.symbols), o, a) : m.symbolsUrl ? L("symbolsUrl").then(function(e) {
            for (var t = "", n = 0; n < e.length; n++)
                t += String.fromCharCode(e[n]);
            m.symbols = JSON.parse(t),
            P(T(r, m.symbols), o, a)
        }).catch(function(e) {
            P(r, o, a)
        }) : P(r, o, a)
    ...
    function D(e) {
        return D.link = D.link || document.createElement("a"),
        D.link.href = e,
        D.link.href
    }
    ...
    k.prototype.cleanUpCache = function() {
        ...
        return this.getMetaDataEntries().then(function(e) {
            ...
            for (a = 0; a < o.length && !(n < k.MaximumCacheSize); ++a)
                r.push(o[a]),
                n -= o[a].size;
            return function e() {
                var t;
    ...
    ,
    k),
    m.cachedFetch = (y = m.UnityCache,
    v = m.fetchWithProgress,
    C = m.readBodyWithProgress,
    function(o, a) {
        var e, t, i = y.getInstance(), s = D("string" == typeof o ? o : o.url), d = {
            enabled: (e = s,
        ...
        function c(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                i.updateRequestMetaData(d.metaData).then(function() {
                    A("'" + d.metaData.url + "' successfully revalidated and served from the browser cache")
                }).catch(function(e) {
                    A("'" + d.metaData.url + "' successfully revalidated but not stored in the browser cache due to the error: " + e)
                }),
                ...
                C(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                    ...
                    Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(d.metaData)]).then(function() {
                        A("'" + s + "' successfully downloaded and stored in the browser cache")
                    }).catch(function(e) {
                        A("'" + s + "' successfully downloaded but not stored in the browser cache due to the error: " + e)
                    }),
                    e
                })) : (A("'" + s + "' request failed with status: " + e.status + " " + e.statusText),
        ...
        d.enabled ? i.loadRequest(s).then(function(e) {
            ...
            i.updateRequestMetaData(r).then(function() {
                A("'" + d.metaData.url + "' served from the browser cache without revalidation")
            }),
            ...
            return A("Failed to load '" + d.metaData.url + "' from browser cache due to the error: " + e),
            v(o, a)
        }) : v(o, a)
    }
    );
    ...
    function L(t) {
        ...
        return n(m[t], {
            ...
            var t, n, r, o, a, i;
            return x.gzip.hasUnityMarker(e.parsedBody) && (t = ["gzip", "gzip"]),
            (t = x.br.hasUnityMarker(e.parsedBody) ? ["brotli", "br"] : t) && (n = e.headers.get("Content-Type"),
    ...
    return new Promise(function(e, t) {
        ...
        new Promise(function(t, e) {
            navigator.gpu ? navigator.gpu.requestAdapter().then(function(e) {
                m.SystemInfo.hasWebGPU = !!e,
                t(m.SystemInfo.hasWebGPU)
            }) : t(!1)
        }
        ).then(function() {
            W()
